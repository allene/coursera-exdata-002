...
png(file="courseproject1-plot3.png", width = 480, height = 480, units = "px", bg="transparent")
# draw plot3 as per requirement
plot(cp1subset$TimeStamp , cp1subset$Sub_metering_1, type="n", col="black", xlab="", ylab = "Energy sub metering")
##Add lines
