...
# open PNG graphics device for plot-1
#png will be like empty canvas
png(file="courseproject1-plot1.png", width = 480, height = 480, units = "px", bg="transparent")
# add histogram to the plot
hist(cp1subset$Global_active_power, col="red", main="Global Active Power", xlab="Global Active Power (kilowatts)")
#close the device
dev.off()
